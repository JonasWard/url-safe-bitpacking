...
import { DataEntry, ParsersForVersionObject, SemanticlyNestedDataEntry, SemanticlyNestedValues, VersionEnumSemantics, VersionRangeType } from '../types';
import { VersionArrayDefinitionType } from '../types/arrayDefinitions';
import { parseVersionArrayDefinitionTypeToVersionDefinitionObject } from './versionArrayDefinitionToObjectDefintion';
import { getURLForData, parseUrlMethod } from './versionReading';
import { updateDataEntry as updateDataEntryObject } from './versionUpdate';

export * from './versionReading';
export * from './versionUpdate';
export * from './versionArrayDefinitionToObjectDefintion';
 ...
 * @param {undefined | Record<string, string> | Record<string, string>[]} semanticsMapping - optional semantics mapping, if nothing given no semantics will be mapped
